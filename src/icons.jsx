...
export const Ic = {
  ...
  home:      mk('0 0 24 24', <><path d="M3 11.5L12 4l9 7.5V20a1 1 0 01-1 1h-5v-6H9v6H4a1 1 0 01-1-1v-8.5z"/></>),
  key:       mk('0 0 24 24', <><circle cx="8.5" cy="9.5" r="4.5"/><path d="M14.5 9.5H21M18.5 9.5v3"/></>),
  lock:      mk('0 0 24 24', <><rect x="5" y="11" width="14" height="11" rx="2"/><path d="M8 11V7.5a4 4 0 018 0V11"/><circle cx="12" cy="16" r="1.2" fill="currentColor" stroke="none"/></>),
  unlock:    mk('0 0 24 24', <><rect x="5" y="11" width="14" height="11" rx="2"/><path d="M8 11V7.5a4 4 0 018 0V5"/><circle cx="12" cy="16" r="1.2" fill="currentColor" stroke="none"/></>),
  walk:      mk('0 0 24 24', <><circle cx="12" cy="4.5" r="2" fill="currentColor" stroke="none"/><path d="M9 22l2.5-6.5 2.5 4 3-7.5"/><path d="M8 11l4.5-5.5 5 3"/></>),
